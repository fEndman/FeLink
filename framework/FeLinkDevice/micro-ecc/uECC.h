...
*/
typedef int (*uECC_RNG_Function)(uint8_t *dest, unsigned size) FELINK_C51_REENTRANT;
...
typedef struct uECC_HashContext {
    void (*init_hash)(struct uECC_HashContext *context) FELINK_C51_REENTRANT ;
    void (*update_hash)(struct uECC_HashContext *context,
                        const uint8_t *message,
                        unsigned message_size) FELINK_C51_REENTRANT ;
    void (*finish_hash)(struct uECC_HashContext *context, uint8_t *hash_result) FELINK_C51_REENTRANT ;

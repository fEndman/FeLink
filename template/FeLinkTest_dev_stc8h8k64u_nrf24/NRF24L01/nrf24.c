...
static void nRF24_WriteReg(uint8_t reg, uint8_t value) FELINK_C51_REENTRANT {
	nRF24_CSN_L();
...
static void nRF24_ReadMBReg(uint8_t reg, uint8_t *pBuf, uint8_t count) FELINK_C51_REENTRANT {
	nRF24_CSN_L();
	nRF24_LL_RW(reg);
	while (count--) {

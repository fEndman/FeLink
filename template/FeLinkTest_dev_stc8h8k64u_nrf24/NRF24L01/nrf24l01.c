...
{
  uint8_t nrf24l01_data_addr[5] = {0x66, 0x6C, 0, 0, 0}; //"FL..."
  nrf24l01_data_addr[2] = (uint8_t)(salt >> 16);
  nrf24l01_data_addr[3] = (uint8_t)(salt >> 8);
  nrf24l01_data_addr[4] = (uint8_t)(salt >> 0);
